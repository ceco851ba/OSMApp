...
const routes = [
    ...
    {
        path: 'pick-location',
        loadChildren: () => __webpack_require__.e(/*! import() | pick-location-pick-location-module */ "pick-location-pick-location-module").then(__webpack_require__.bind(null, /*! ./pick-location/pick-location.module */ "./src/app/pick-location/pick-location.module.ts")).then(m => m.PickLocationPageModule)
    },
];
